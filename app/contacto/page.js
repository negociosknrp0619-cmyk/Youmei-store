      ...
      <section className={`container ${styles.contactSection}`}>
        <div className={styles.contactGrid}>
          ...
          <div className={styles.infoWrapper}>
            ...
            <a href="https://wa.me/51983725740?text=Hola%20Youmei%20Store%2C%20tengo%20una%20consulta" target="_blank" rel="noopener noreferrer" className={styles.infoCard} style={{textDecoration: 'none'}}>
              <div className={styles.infoIcon}>
