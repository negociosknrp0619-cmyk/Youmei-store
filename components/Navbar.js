      ...
      <header className={`${styles.header} ${scrolled ? styles.scrolled : ''}`}>
        <div className={`container ${styles.navbar}`}>
          ...
          <div className={styles.rightIcons}>
            ...
            <Link href="/favoritos" className={styles.iconBtn} aria-label="Favoritos" style={{ marginRight: '8px' }}>
        ...
        <div className={styles.mobileOverlay} onClick={() => setMobileMenuOpen(false)}>
          <div className={styles.mobileDrawer} onClick={(e) => e.stopPropagation()}>
            ...
            <nav className={styles.drawerLinks}>
              ...
              <Link href="/favoritos" onClick={() => setMobileMenuOpen(false)} className={styles.drawerItem}>Mis Favoritos</Link>
              <Link href="/perfil" onClick={() => setMobileMenuOpen(false)} className={styles.drawerItem}>Mi Cuenta</Link>
            </nav>
