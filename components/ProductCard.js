      ...
      <div className={styles.info}>
        ...
        <div className={styles.actions}>
          ...
          <button 
            ...
            style={{ color: isFavorite(product.id) ? '#e91e63' : 'currentColor' }}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill={isFavorite(product.id) ? '#e91e63' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
